#!/usr/bin/env python3
"""
Quick test of geometry2 learner on one problem (left_of)
"""
...
from load_geometry2_data import load_left_of_data

def test_left_of_quick():
    """Quick test on left_of problem with small dataset"""
    print("Quick test: Geometry2 left_of problem")
    
    data_dir = os.path.join(os.path.dirname(__file__), 'data')
    examples_file = os.path.join(data_dir, 'left_of_examples.pl')
    bk_file = os.path.join(data_dir, 'left_of_BK.pl')
    ...
    X, y, _ = load_left_of_data(examples_file, bk_file)
    ...
    learner.target_predicate = 'left_of'
